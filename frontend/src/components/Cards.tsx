    ...
    <ul className="mt-8 space-y-2">
      <li>
        <div className="flex items-center gap-x-2">
          ...
          <span>{ownedCards.find((c) => c.card_id === 'A01')?.amount_owned || 0}</span>
          <button
            type="button"
            onClick={() => updateCardCount('A01', 1)}
            className="cursor-pointer rounded-full bg-indigo-600 p-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
      ...
      <li>
        <div className="flex items-center gap-x-2">
          ...
          <span>{ownedCards.find((c) => c.card_id === 'A02')?.amount_owned || 0}</span>
          <button
            type="button"
            onClick={() => updateCardCount('A02', 1)}
            className="cursor-pointer rounded-full bg-indigo-600 p-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
